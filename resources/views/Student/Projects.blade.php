...
@endif
            ...
            <div class="row justify-content-center">
                <div class="col-lg-11 col-xl-10">
                    ...
                    <ul class="nav nav-tabs nav-fill" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#yourProjects" role="tab"
                                aria-controls="yourProjects" aria-selected="true">Your Projects</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#allProjects" role="tab"
                                aria-controls="allProjects" aria-selected="false">All Projects</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="yourProjects" role="tabpanel" data-filter-list="content-list-body">
    ...
    @if ($project && $project->id)
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body">
                    <!-- Use the project's ID to generate the URL, no need for the 'first()' method -->
                    <a href="{{ route('student.student.group',['projectId' => $project->id]) }}">
                        <h4 class="card-title" data-filter-by="text">{{ $project->project_name }}</h4>
                    </a>
...
@endforeach
                        ...
                        <div class="tab-pane fade" id="allProjects" role="tabpanel" data-filter-list="content-list-body">
                            <div class="content-list">
                                <div class="row content-list-head">
                                    <div class="col-auto">
                                        <h3>All Projects</h3>
                                ...
                                <!--end of content list head-->
                                <div class="content-list-body row">
                                    <!-- Add all projects data here -->
                                    @foreach ($projectsall as $project)
                                        <div class="col-md-4">
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    <h5 class="card-title">{{ $project->project_name }}</h5>
                                                    <p class="card-text"><strong>Project Type:</strong> {{ $project->project_type }}
                                                    </p>
                                                    <div>
                                                        <!-- Display the project status from the status column -->
                                                        <span class="text-small">{{ $project->status }}</span>
