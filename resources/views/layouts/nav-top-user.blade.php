...
<!-- Mirrored from pipeline.mediumra.re/nav-top-user.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 08:24:20 GMT -->
          ...
          <div class="d-block d-lg-none ml-2">
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ route('login') }}" id="logout-link" class="dropdown-item">Log Out</a>
              </div>
            </div>
          </div>
        </div>
