    ...
    <button type="submit">Save</button>
                ...
                <div class="d-none d-lg-block w-100">
                    ...
                    <ul class="nav nav-small flex-column mt-2">
                        <li class="nav-item">
                            <a href="{{ route('supervisor.projects.index') }}" class="nav-link">Projects</a>
                        </li>
...
<!-- all users profilepic should be display here-->
              ...
              <ul class="nav nav-tabs nav-fill" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#projects" role="tab" aria-controls="projects" aria-selected="true">Assigned Projects</a>
                </li>
                <li class="nav-item">
